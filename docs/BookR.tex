...
\StringTok{"AU"} \OperatorTok{%in%}\StringTok{ }\NormalTok{EU}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{c}\NormalTok{(}\StringTok{"AU"}\NormalTok{,}\StringTok{"HU"}\NormalTok{,}\StringTok{"UK"}\NormalTok{) }\OperatorTok{%in%}\StringTok{ }\NormalTok{EU}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{input_data_frame }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{dplyr_function_one}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{dplyr_function_two}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{dplyr_function_three}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pres_results_}\DecValTok{2016}\NormalTok{ <-}\StringTok{ }\NormalTok{pres_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(year}\OperatorTok{==}\DecValTok{2016}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pres_results_subset <-}\StringTok{ }\NormalTok{pres_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(state }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"TX"}\NormalTok{,}
...
\begin{Highlighting}[]
\KeywordTok{tibble}\NormalTok{(}
\NormalTok{pres_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(year}\OperatorTok{==}\DecValTok{2016}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(state, dem, rep) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(dem))}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{result <-}\StringTok{ }\NormalTok{pres_results }\OperatorTok{%<>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(year}\OperatorTok{==}\DecValTok{2016}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(state, dem) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(}\KeywordTok{desc}\NormalTok{(dem))}
\KeywordTok{tibble}\NormalTok{(result)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(country }\OperatorTok{==}\StringTok{ "Austria"}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Highlighting}[]
\NormalTok{gapminder }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(year }\OperatorTok{==}\StringTok{ }\DecValTok{2007}\NormalTok{, continent }\OperatorTok{==}\StringTok{ "Europe"}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Highlighting}[]
\NormalTok{gapminder }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(year }\OperatorTok{==}\StringTok{ }\DecValTok{2007}\NormalTok{, continent }\OperatorTok{==}\StringTok{ "Americas"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(country, pop) }\OperatorTok{%>%}
